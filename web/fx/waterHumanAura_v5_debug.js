const BUILD_TAG = "waterHumanAura_v5_debug / 2026-03-10 15:35 JST";
...
export default {
  id: "waterHumanAura",
  label: "Water + Human Aura v5 debug",
  desc: "常時青点灯の上に水面下エフェクトを重ね、人の半径50cmだけを人物色で置換。デバッグ用にマゼンタ点滅マーカー付き。",
  ...
  params: [
    ...
    { key: "debugVersionMarker", label: "Debug Marker", type: "checkbox", default: true },
